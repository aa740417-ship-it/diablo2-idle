...
function enemyAttackSummon(mob, s) {
    ...
    if (mob._sherine) dmg = Math.floor(dmg * (mob._sherineDmgMult || (mob._sherineMad ? 3 : 2)));
...
function applyMobMagicToSummon(mob, sk, s) {
    ...
    const shMul = (mob._sherine ? (mob._sherineDmgMult || (mob._sherineMad ? 3 : 2)) : 1) * (mob._grace ? 2 : 1);
